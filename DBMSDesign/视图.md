...
AS SELECT DISTINCT x.IID, x.INAME, x.STID, y.STID, z.STID, w.STID
   FROM station_encoding x LEFT JOIN station_encoding y ON x.IID = y.IID
    LEFT JOIN station_encoding z ON x.IID = z.IID
    LEFT JOIN station_encoding w ON x.IID = w.IID
   WHERE x.STTYPE = '基础水文'  y.STTYPE = '降水蒸发' AND z.STTYPE = '实时雨水情' AND w.STTYPE = '水质';
