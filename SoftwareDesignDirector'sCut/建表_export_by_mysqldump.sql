...
CREATE TABLE `import_history` (
  ...
  `import_url` varchar(50) NOT NULL,
...
INSERT INTO `import_history` VALUES (1,'MySQL','jdbc:mysql://localhost:3306/homo','2025-02-21 12:00:00',100),(4,'MySQL','jdbc:mysql://localhost:3306/haha','2025-02-23 02:21:56',50),(5,'MySQL','http://127.0.0.1/','2025-03-08 23:34:39',5);
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `before_import_history_insert` BEFORE INSERT ON `import_history` FOR EACH ROW BEGIN

    IF NEW.import_type NOT IN ('MySQL', 'MinIO', 'LocalFile') THEN

        SIGNAL SQLSTATE '23333'

            SET MESSAGE_TEXT = 'import_type must be one of the following: MySQL, MinIO, LocalFile';
...
INSERT INTO `station_encoding` VALUES ('104.0001','基础水文','艾家镇','ajz','60107320',' '),('104.0002','基础水文','巴东','bd','60106720',' '),('104.0002','实时雨水情','巴东','bd','60106700',' '),('104.0002','水质','巴东','bd','60106700',' '),('104.0002','降水蒸发','巴东','bd','60538700',' '),('104.0003','基础水文','坝河口','bhk','60107140',' '),('104.0003','实时雨水情','坝河口','bhk','60107140',' '),('104.0003','降水蒸发','坝河口','bhk','60540210',' '),('104.0004','基础水文','宝塔河','bth','60107310',' '),('104.0005','基础水文','风箱沱','fxt','60107191',' '),('104.002','基础水文','茅坪','mp','60107000',' '),('104.002','实时雨水情','茅坪','mp','60107000',' '),('104.0021','基础水文','梅溪河口','mxhk','60513500',' '),('104.0023','基础水文','庙咀','mj','60107270',' '),('104.0023','实时雨水情','庙咀','mj','60107270',' '),('104.0028','基础水文','三斗坪','sdp','60107100',' '),('104.0028','实时雨水情','三斗坪','sdp','60107100',' '),('104.0028','降水蒸发','三斗坪','sdp','60540200',' '),('104.0032','实时雨水情','太平溪','tpx','60106900',' '),('104.0033','基础水文','覃家沱','qjt','60107110',' '),('104.0033','实时雨水情','覃家沱','qjt','60107110',' '),('104.0037','水质','晓溪塔','xxt','60980100',' '),('104.0047','基础水文','中隔岛','zgd','60107070',' '),('999.9999','基础水文','飞来峡','flx','11451419','广东省清远市飞来峡水利枢纽'),('999.9999','实时雨水情','飞来峡','flx','123','广东省清远市飞来峡水利枢纽'),('999.9999','水质','飞来峡','flx','11451419','广东省清远市飞来峡水利枢纽'),('999.9999','降水蒸发','飞来峡','flx','11451419','广东省清远市飞来峡水利枢纽');
...
INSERT INTO `user` VALUES (1,'diana','1234',1),(4,'1234','1234',0);
...
-- Dump completed on 2025-07-27 20:38:43
